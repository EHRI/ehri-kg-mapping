...
shexml_first_part = r"""
IMPORT <ShExMLTemplates/partial/InstitutionsCopiesAndLinksHeader.shexml>
SOURCE links_files <institutionsCopiesAndLinks\institutionsCopiesAndLinks_"""

shexml_second_part = r""".json>
IMPORT <ShExMLTemplates/partial/InstitutionsCopiesAndLinksIteratorsAndShapes.shexml>
"""
...
def convert_to_rdf(i, created_files, folder):
    ...
    output_filename = "./shexmlOutputInstitutionsCopiesAndLinks/holdingsCopiesAndLinks_" + str(index + 1) + ".ttl"
    content_filename = "./" + folder + "/holdingsCopiesAndLinks_" + str(index + 1) + ".json"
...
if __name__ == '__main__':
    ...
    for i in os.scandir(folder):
        filename = "institutionsCopiesAndLinks_" + str(index + 1) + ".shexml"
        f = open("./shexmlRulesInstitutionsCopiesAndLinks/" + filename, "w")
        f.write(shexml_first_part + str(index + 1) + shexml_second_part)
        f.close()
        created_files.append("./shexmlRulesInstitutionsCopiesAndLinks/" + filename)
