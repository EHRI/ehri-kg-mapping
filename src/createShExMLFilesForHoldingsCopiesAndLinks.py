...
shexml_first_part = r"""
IMPORT <ShExMLTemplates/partial/HoldingsCopiesAndLinksHeader.shexml>
SOURCE links_files <holdingsCopiesAndLinks\holdingsCopiesAndLinks_"""

shexml_second_part = r""".json>
IMPORT <ShExMLTemplates/partial/HoldingsCopiesAndLinksIteratorsAndShapes.shexml>
"""
...
def convert_to_rdf(i, created_files, folder):
    ...
    output_filename = "./shexmlOutputHoldingsCopiesAndLinks/holdingsCopiesAndLinks_" + str(index + 1) + ".ttl"
...
if __name__ == '__main__':
    ...
    for i in os.scandir(folder):
        filename = "holdingsCopiesAndLinks_" + str(index + 1) + ".shexml"
        f = open("./shexmlRulesHoldingsCopiesAndLinks/" + filename, "w")
        f.write(shexml_first_part + str(index + 1) + shexml_second_part)
        f.close()
        created_files.append("./shexmlRulesHoldingsCopiesAndLinks/" + filename)
