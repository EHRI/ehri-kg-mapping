...
if [ ! -d apache-jena ]; then
    ...
    curl -L https://archive.apache.org/dist/jena/binaries/apache-jena-6.1.0.zip -o apache-jena.zip
    unzip -q apache-jena.zip -d apache-jena
fi

#export _JAVA_OPTIONS="-Xmx12g"

shex="apache-jena/apache-jena-6.0.0/bin/shex"
shacl="apache-jena/apache-jena-6.0.0/bin/shacl"
